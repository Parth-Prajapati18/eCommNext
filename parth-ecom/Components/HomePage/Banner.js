...
export default function Banner() {
  return (
    <div className='my-1 relative overflow-hidden'>
        <div className='absolute top-1/4 pl-3 md:pl-10' ><span className='text-xl sm:text-2xl md:text-3xl xl:text-6xl text-red-800' style={{fontFamily: " 'Patua One', cursive "}}>"Where Quality <br className='block md:hidden'/> Meets Convenience!"</span>
