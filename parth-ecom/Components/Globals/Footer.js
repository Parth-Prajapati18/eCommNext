...
export default function Footer() {
  return (
    <div className='p-5 overflow-hidde' style={{ backgroundColor: 'black', color: "white" }}>
      <div className='grid grid-col-1 sm:grid-cols-4 relative gap-x-8 gap-y-16'>
        ...
        <div>
          <div className='px-5 text-center '>
            <h1 className='text-xl font-normal pb-4 pt-2'>Support</h1>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Support </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Billing Support </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Pay without signing In </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > FAQ </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Community </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Service Updates </Link>
            <Link className="font-normal block py-1 no-underline" href='https://www.flipkart.com/' target='_blank' rel="noopener noreferrer" > Site Map </Link>
          </div>
        </div>
